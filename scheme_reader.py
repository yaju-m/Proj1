...
def scheme_read(src):
    ...
    if val == 'nil':
        ...
        # BEGIN PROBLEM 1
        # recursicvely call read_tail and retun result
...
def read_tail(src):
    ...
    try:
        if src.current() is None:
            ...
            # BEGIN PROBLEM 2
            #read one additional expression 
            #check to see if closing parenthesis follows
            #return as Pair
            src.remove_front()
            ...
            #recursively call orig expression until the matching ) parenthesis
